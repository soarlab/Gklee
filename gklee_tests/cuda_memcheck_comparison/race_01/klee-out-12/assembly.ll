...
@_ZZ13device_globalPjS_iE9my_shared = internal global [64 x i32] zeroinitializer, section "__shared__", align 16
...
entry:
  ...
  %arrayidx = getelementptr inbounds [64 x i32]* @_ZZ13device_globalPjS_iE9my_shared, i32 0, i64 %idxprom, !dbg !738
  ...
  br i1 %cmp, label %if.then, label %if.end12, !dbg !740, !br-S-S !741

if.then:                                          ; preds = %entry
  %11 = load i32* %my_index, align 4, !dbg !742
  %idxprom5 = sext i32 %11 to i64, !dbg !742
  %12 = load i32** %array_b.addr, align 8, !dbg !742
  %arrayidx6 = getelementptr inbounds i32* %12, i64 %idxprom5, !dbg !742
  %13 = load i32* %arrayidx6, align 4, !dbg !742
  %14 = load i32* %my_index, align 4, !dbg !742
  %idxprom7 = sext i32 %14 to i64, !dbg !742
  %arrayidx8 = getelementptr inbounds [64 x i32]* @_ZZ13device_globalPjS_iE9my_shared, i32 0, i64 %idxprom7, !dbg !742
  %15 = load i32* %arrayidx8, align 4, !dbg !742
  %cmp9 = icmp eq i32 %13, %15, !dbg !742
  br i1 %cmp9, label %if.then10, label %if.end12, !dbg !742, !br-S-S !741

if.then10:                                        ; preds = %if.then
  %16 = load i32* %my_index, align 4, !dbg !744
  %17 = load i32** %array_a.addr, align 8, !dbg !744
  %arrayidx11 = getelementptr inbounds i32* %17, i64 0, !dbg !744
  store i32 %16, i32* %arrayidx11, align 4, !dbg !744
  br label %if.end12, !dbg !746
...
entry:
  %this.addr.i.i1 = alloca %struct.dim3*, align 8
  %vx.addr.i.i2 = alloca i32, align 4
  %vy.addr.i.i3 = alloca i32, align 4
  %vz.addr.i.i4 = alloca i32, align 4
  %this.addr.i5 = alloca %struct.dim3*, align 8
  %vx.addr.i6 = alloca i32, align 4
  %vy.addr.i7 = alloca i32, align 4
  %vz.addr.i8 = alloca i32, align 4
  ...
  %call = call noalias i8* @malloc(i64 256) nounwind, !dbg !748
  %0 = bitcast i8* %call to i32*, !dbg !748
  store i32* %0, i32** %host_array, align 8, !dbg !748
  store i32* null, i32** %device_array_a, align 8, !dbg !750
  %1 = bitcast i32** %device_array_a to i8**, !dbg !751
  %call1 = call i32 @cudaMalloc(i8** %1, i64 256), !dbg !751
  store i32* null, i32** %device_array_b, align 8, !dbg !752
  %2 = bitcast i32** %device_array_b to i8**, !dbg !753
  %call2 = call i32 @cudaMalloc(i8** %2, i64 256), !dbg !753
  %3 = load i32** %host_array, align 8, !dbg !754
  %cmp = icmp eq i32* %3, null, !dbg !754
...
if.end:                                           ; preds = %entry
  %4 = load i32** %device_array_a, align 8, !dbg !757
  %cmp3 = icmp eq i32* %4, null, !dbg !757
  br i1 %cmp3, label %if.then4, label %if.end5, !dbg !757

if.then4:                                         ; preds = %if.end
  store i32 2, i32* %retval, !dbg !758
  br label %return, !dbg !758

if.end5:                                          ; preds = %if.end
  %5 = load i32** %device_array_b, align 8, !dbg !760
  %cmp6 = icmp eq i32* %5, null, !dbg !760
  br i1 %cmp6, label %if.then7, label %if.end8, !dbg !760

if.then7:                                         ; preds = %if.end5
  store i32 3, i32* %retval, !dbg !761
...
for.cond:                                         ; preds = %for.inc, %if.end8
  %6 = load i32* %i, align 4, !dbg !763
  %cmp9 = icmp slt i32 %6, 64, !dbg !763
  br i1 %cmp9, label %for.body, label %for.end, !dbg !763

for.body:                                         ; preds = %for.cond
  %7 = load i32* %i, align 4, !dbg !765
  %int_cast_to_i64 = zext i32 2 to i64
  call void @klee_div_zero_check(i64 %int_cast_to_i64)
  %rem = srem i32 %7, 2, !dbg !765
  %cmp10 = icmp eq i32 %rem, 0, !dbg !765
  %8 = load i32* %i, align 4, !dbg !767
  br i1 %cmp10, label %if.then11, label %if.else, !dbg !765

if.then11:                                        ; preds = %for.body
  %9 = load i32* %i, align 4, !dbg !767
  %idxprom = sext i32 %9 to i64, !dbg !767
  %10 = load i32** %host_array, align 8, !dbg !767
  %arrayidx = getelementptr inbounds i32* %10, i64 %idxprom, !dbg !767
  store i32 %8, i32* %arrayidx, align 4, !dbg !767
  br label %for.inc, !dbg !769

if.else:                                          ; preds = %for.body
  %idxprom12 = sext i32 %8 to i64, !dbg !770
  %11 = load i32** %host_array, align 8, !dbg !770
  %arrayidx13 = getelementptr inbounds i32* %11, i64 %idxprom12, !dbg !770
  store i32 0, i32* %arrayidx13, align 4, !dbg !770
  br label %for.inc

for.inc:                                          ; preds = %if.then11, %if.else
  %12 = load i32* %i, align 4, !dbg !763
  %inc = add nsw i32 %12, 1, !dbg !763
  store i32 %inc, i32* %i, align 4, !dbg !763
  br label %for.cond, !dbg !763

for.end:                                          ; preds = %for.cond
  %13 = load i32** %device_array_a, align 8, !dbg !772
  %14 = bitcast i32* %13 to i8*, !dbg !772
  %15 = load i32** %host_array, align 8, !dbg !772
  %16 = bitcast i32* %15 to i8*, !dbg !772
  %call15 = call i32 @cudaMemcpy(i8* %14, i8* %16, i64 64, i32 1), !dbg !772
  store i32 0, i32* %i16, align 4, !dbg !773
  br label %for.cond17, !dbg !773

for.cond17:                                       ; preds = %for.inc31, %for.end
  %17 = load i32* %i16, align 4, !dbg !773
  %cmp18 = icmp slt i32 %17, 64, !dbg !773
  br i1 %cmp18, label %for.body19, label %for.end33, !dbg !773

for.body19:                                       ; preds = %for.cond17
  %18 = load i32* %i16, align 4, !dbg !775
  %int_cast_to_i641 = zext i32 2 to i64
  call void @klee_div_zero_check(i64 %int_cast_to_i641)
  %rem20 = srem i32 %18, 2, !dbg !775
  %cmp21 = icmp eq i32 %rem20, 0, !dbg !775
  br i1 %cmp21, label %land.lhs.true, label %if.else27, !dbg !775

land.lhs.true:                                    ; preds = %for.body19
  %19 = load i32* %i16, align 4, !dbg !775
  %int_cast_to_i642 = zext i32 3 to i64
  call void @klee_div_zero_check(i64 %int_cast_to_i642)
  %rem22 = srem i32 %19, 3, !dbg !775
  %cmp23 = icmp eq i32 %rem22, 0, !dbg !775
  br i1 %cmp23, label %if.then24, label %if.else27, !dbg !775

if.then24:                                        ; preds = %land.lhs.true
  %20 = load i32* %i16, align 4, !dbg !777
  %21 = load i32* %i16, align 4, !dbg !777
  %idxprom25 = sext i32 %21 to i64, !dbg !777
  %22 = load i32** %host_array, align 8, !dbg !777
  %arrayidx26 = getelementptr inbounds i32* %22, i64 %idxprom25, !dbg !777
  store i32 %20, i32* %arrayidx26, align 4, !dbg !777
  br label %for.inc31, !dbg !779

if.else27:                                        ; preds = %land.lhs.true, %for.body19
  %23 = load i32* %i16, align 4, !dbg !780
  %idxprom28 = sext i32 %23 to i64, !dbg !780
  %24 = load i32** %host_array, align 8, !dbg !780
  %arrayidx29 = getelementptr inbounds i32* %24, i64 %idxprom28, !dbg !780
  store i32 0, i32* %arrayidx29, align 4, !dbg !780
  br label %for.inc31

for.inc31:                                        ; preds = %if.then24, %if.else27
  %25 = load i32* %i16, align 4, !dbg !773
  %inc32 = add nsw i32 %25, 1, !dbg !773
  store i32 %inc32, i32* %i16, align 4, !dbg !773
  br label %for.cond17, !dbg !773

for.end33:                                        ; preds = %for.cond17
  %26 = load i32** %device_array_b, align 8, !dbg !782
  %27 = bitcast i32* %26 to i8*, !dbg !782
  %28 = load i32** %host_array, align 8, !dbg !782
  %29 = bitcast i32* %28 to i8*, !dbg !782
  %call34 = call i32 @cudaMemcpy(i8* %27, i8* %29, i64 64, i32 1), !dbg !782
  %30 = bitcast %struct.dim3** %this.addr.i to i8*
  %31 = bitcast i32* %vx.addr.i to i8*
  %32 = bitcast i32* %vy.addr.i to i8*
  %33 = bitcast i32* %vz.addr.i to i8*
  ...
  %34 = load i32* %vx.addr.i, align 4, !dbg !783
  %35 = load i32* %vy.addr.i, align 4, !dbg !783
  %36 = load i32* %vz.addr.i, align 4, !dbg !783
  %37 = bitcast %struct.dim3** %this.addr.i.i to i8*
  %38 = bitcast i32* %vx.addr.i.i to i8*
  %39 = bitcast i32* %vy.addr.i.i to i8*
  %40 = bitcast i32* %vz.addr.i.i to i8*
  store %struct.dim3* %this1.i, %struct.dim3** %this.addr.i.i, align 8
  store i32 %34, i32* %vx.addr.i.i, align 4
  store i32 %35, i32* %vy.addr.i.i, align 4
  store i32 %36, i32* %vz.addr.i.i, align 4
  %this1.i.i = load %struct.dim3** %this.addr.i.i
  %x.i.i = getelementptr inbounds %struct.dim3* %this1.i.i, i32 0, i32 0, !dbg !786
  %41 = load i32* %vx.addr.i.i, align 4, !dbg !786
  store i32 %41, i32* %x.i.i, align 4, !dbg !786
  %y.i.i = getelementptr inbounds %struct.dim3* %this1.i.i, i32 0, i32 1, !dbg !786
  %42 = load i32* %vy.addr.i.i, align 4, !dbg !786
  store i32 %42, i32* %y.i.i, align 4, !dbg !786
  %z.i.i = getelementptr inbounds %struct.dim3* %this1.i.i, i32 0, i32 2, !dbg !786
  %43 = load i32* %vz.addr.i.i, align 4, !dbg !786
  store i32 %43, i32* %z.i.i, align 4, !dbg !786
  %44 = bitcast %struct.dim3** %this.addr.i.i to i8*, !dbg !787
  %45 = bitcast i32* %vx.addr.i.i to i8*, !dbg !787
  %46 = bitcast i32* %vy.addr.i.i to i8*, !dbg !787
  %47 = bitcast i32* %vz.addr.i.i to i8*, !dbg !787
  %48 = bitcast %struct.dim3** %this.addr.i to i8*, !dbg !783
  %49 = bitcast i32* %vx.addr.i to i8*, !dbg !783
  %50 = bitcast i32* %vy.addr.i to i8*, !dbg !783
  %51 = bitcast i32* %vz.addr.i to i8*, !dbg !783
  %52 = bitcast %struct.dim3** %this.addr.i5 to i8*
  %53 = bitcast i32* %vx.addr.i6 to i8*
  %54 = bitcast i32* %vy.addr.i7 to i8*
  %55 = bitcast i32* %vz.addr.i8 to i8*
  store %struct.dim3* %agg.tmp35, %struct.dim3** %this.addr.i5, align 8
  store i32 64, i32* %vx.addr.i6, align 4
  store i32 1, i32* %vy.addr.i7, align 4
  store i32 1, i32* %vz.addr.i8, align 4
  %this1.i9 = load %struct.dim3** %this.addr.i5
  %56 = load i32* %vx.addr.i6, align 4, !dbg !783
  %57 = load i32* %vy.addr.i7, align 4, !dbg !783
  %58 = load i32* %vz.addr.i8, align 4, !dbg !783
  %59 = bitcast %struct.dim3** %this.addr.i.i1 to i8*
  %60 = bitcast i32* %vx.addr.i.i2 to i8*
  %61 = bitcast i32* %vy.addr.i.i3 to i8*
  %62 = bitcast i32* %vz.addr.i.i4 to i8*
  store %struct.dim3* %this1.i9, %struct.dim3** %this.addr.i.i1, align 8
  store i32 %56, i32* %vx.addr.i.i2, align 4
  store i32 %57, i32* %vy.addr.i.i3, align 4
  store i32 %58, i32* %vz.addr.i.i4, align 4
  %this1.i.i10 = load %struct.dim3** %this.addr.i.i1
  %x.i.i11 = getelementptr inbounds %struct.dim3* %this1.i.i10, i32 0, i32 0, !dbg !786
  %63 = load i32* %vx.addr.i.i2, align 4, !dbg !786
  store i32 %63, i32* %x.i.i11, align 4, !dbg !786
  %y.i.i12 = getelementptr inbounds %struct.dim3* %this1.i.i10, i32 0, i32 1, !dbg !786
  %64 = load i32* %vy.addr.i.i3, align 4, !dbg !786
  store i32 %64, i32* %y.i.i12, align 4, !dbg !786
  %z.i.i13 = getelementptr inbounds %struct.dim3* %this1.i.i10, i32 0, i32 2, !dbg !786
  %65 = load i32* %vz.addr.i.i4, align 4, !dbg !786
  store i32 %65, i32* %z.i.i13, align 4, !dbg !786
  %66 = bitcast %struct.dim3** %this.addr.i.i1 to i8*, !dbg !787
  %67 = bitcast i32* %vx.addr.i.i2 to i8*, !dbg !787
  %68 = bitcast i32* %vy.addr.i.i3 to i8*, !dbg !787
  %69 = bitcast i32* %vz.addr.i.i4 to i8*, !dbg !787
  %70 = bitcast %struct.dim3** %this.addr.i5 to i8*, !dbg !783
  %71 = bitcast i32* %vx.addr.i6 to i8*, !dbg !783
  %72 = bitcast i32* %vy.addr.i7 to i8*, !dbg !783
  %73 = bitcast i32* %vz.addr.i8 to i8*, !dbg !783
  %74 = bitcast { i64, i32 }* %agg.tmp.coerce to i8*, !dbg !784
  %75 = bitcast %struct.dim3* %agg.tmp to i8*, !dbg !784
  %76 = call i8* @memcpy(i8* %74, i8* %75, i64 12)
  %77 = getelementptr { i64, i32 }* %agg.tmp.coerce, i32 0, i32 0, !dbg !784
  %78 = load i64* %77, align 1, !dbg !784
  %79 = getelementptr { i64, i32 }* %agg.tmp.coerce, i32 0, i32 1, !dbg !784
  %80 = load i32* %79, align 1, !dbg !784
  %81 = bitcast { i64, i32 }* %agg.tmp35.coerce to i8*, !dbg !784
  %82 = bitcast %struct.dim3* %agg.tmp35 to i8*, !dbg !784
  %83 = call i8* @memcpy(i8* %81, i8* %82, i64 12)
  %84 = getelementptr { i64, i32 }* %agg.tmp35.coerce, i32 0, i32 0, !dbg !784
  %85 = load i64* %84, align 1, !dbg !784
  %86 = getelementptr { i64, i32 }* %agg.tmp35.coerce, i32 0, i32 1, !dbg !784
  %87 = load i32* %86, align 1, !dbg !784
  call void (i64, i32, i64, i32, ...)* @__set_CUDAConfig(i64 %78, i32 %80, i64 %85, i32 %87), !dbg !784
  %88 = load i32** %device_array_a, align 8, !dbg !789
  %89 = load i32** %device_array_b, align 8, !dbg !789
  call void @_Z13device_globalPjS_i(i32* %88, i32* %89, i32 64), !dbg !789
  %90 = load i32** %host_array, align 8, !dbg !790
  %91 = bitcast i32* %90 to i8*, !dbg !790
  %92 = load i32** %device_array_a, align 8, !dbg !790
  %93 = bitcast i32* %92 to i8*, !dbg !790
  %call36 = call i32 @cudaMemcpy(i8* %91, i8* %93, i64 64, i32 2), !dbg !790
  store i32 0, i32* %i37, align 4, !dbg !791
  br label %for.cond38, !dbg !791

for.cond38:                                       ; preds = %for.end49, %for.end33
  %94 = load i32* %i37, align 4, !dbg !791
  %cmp39 = icmp slt i32 %94, 64, !dbg !791
  br i1 %cmp39, label %for.body40, label %for.end53, !dbg !791

for.body40:                                       ; preds = %for.cond38
  store i32 0, i32* %j, align 4, !dbg !793
  br label %for.cond41, !dbg !793

for.cond41:                                       ; preds = %for.body43, %for.body40
  %95 = load i32* %j, align 4, !dbg !793
  %cmp42 = icmp slt i32 %95, 64, !dbg !793
  br i1 %cmp42, label %for.body43, label %for.end49, !dbg !793

for.body43:                                       ; preds = %for.cond41
  %96 = load i32* %i37, align 4, !dbg !796
  %97 = load i32* %j, align 4, !dbg !796
  %add = add nsw i32 %96, %97, !dbg !796
  %idxprom44 = sext i32 %add to i64, !dbg !796
  %98 = load i32** %host_array, align 8, !dbg !796
  %arrayidx45 = getelementptr inbounds i32* %98, i64 %idxprom44, !dbg !796
  %99 = load i32* %arrayidx45, align 4, !dbg !796
  %call46 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([5 x i8]* @.str, i32 0, i32 0), i32 %99), !dbg !796
  %100 = load i32* %j, align 4, !dbg !793
  %inc48 = add nsw i32 %100, 1, !dbg !793
  store i32 %inc48, i32* %j, align 4, !dbg !793
  br label %for.cond41, !dbg !793

for.end49:                                        ; preds = %for.cond41
  %call50 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([2 x i8]* @.str1, i32 0, i32 0)), !dbg !798
  %101 = load i32* %i37, align 4, !dbg !791
  %add52 = add nsw i32 %101, 64, !dbg !791
  store i32 %add52, i32* %i37, align 4, !dbg !791
  br label %for.cond38, !dbg !791

for.end53:                                        ; preds = %for.cond38
  %102 = load i32** %host_array, align 8, !dbg !799
  %103 = bitcast i32* %102 to i8*, !dbg !799
  call void @free(i8* %103) nounwind, !dbg !799
  %104 = load i32** %device_array_a, align 8, !dbg !800
  %105 = bitcast i32* %104 to i8*, !dbg !800
  %call54 = call i32 @cudaFree(i8* %105), !dbg !800
  %106 = load i32** %device_array_b, align 8, !dbg !801
  %107 = bitcast i32* %106 to i8*, !dbg !801
  %call55 = call i32 @cudaFree(i8* %107), !dbg !801
  br label %return, !dbg !802

return:                                           ; preds = %for.end53, %if.then7, %if.then4, %if.then
  %108 = load i32* %retval, !dbg !802
  ret i32 %108, !dbg !802
}
...
entry:
  %cmp3 = icmp eq i64 %len, 0, !dbg !807
  br i1 %cmp3, label %while.end, label %while.body, !dbg !807
...
while.body:                                       ; preds = %while.body, %entry
  ...
  %dec = add i64 %len.addr.04, -1, !dbg !807
  %incdec.ptr = getelementptr inbounds i8* %src.06, i64 1, !dbg !808
  %0 = load i8* %src.06, align 1, !dbg !808, !tbaa !809
  %incdec.ptr1 = getelementptr inbounds i8* %dest.05, i64 1, !dbg !808
  store i8 %0, i8* %dest.05, align 1, !dbg !808, !tbaa !809
  %cmp = icmp eq i64 %dec, 0, !dbg !807
  br i1 %cmp, label %while.end, label %while.body, !dbg !807

while.end:                                        ; preds = %while.body, %entry
  ret i8* %destaddr, !dbg !811
}

define i8* @memset(i8* %dst, i32 %s, i64 %count) nounwind uwtable {
entry:
  %cmp2 = icmp eq i64 %count, 0, !dbg !812
  br i1 %cmp2, label %while.end, label %while.body.lr.ph, !dbg !812

while.body.lr.ph:                                 ; preds = %entry
  %conv = trunc i32 %s to i8, !dbg !813
  br label %while.body, !dbg !812

while.body:                                       ; preds = %while.body, %while.body.lr.ph
  %a.04 = phi i8* [ %dst, %while.body.lr.ph ], [ %incdec.ptr, %while.body ]
  %count.addr.03 = phi i64 [ %count, %while.body.lr.ph ], [ %dec, %while.body ]
  %dec = add i64 %count.addr.03, -1, !dbg !812
  %incdec.ptr = getelementptr inbounds i8* %a.04, i64 1, !dbg !813
  store volatile i8 %conv, i8* %a.04, align 1, !dbg !813, !tbaa !809
  %cmp = icmp eq i64 %dec, 0, !dbg !812
  br i1 %cmp, label %while.end, label %while.body, !dbg !812
...
entry:
  tail call void @free(i8* %devPtr) nounwind, !dbg !817
  ret i32 0, !dbg !819
}

define i32 @cudaFreeArray(%struct.cudaArray* nocapture %array) nounwind uwtable {
entry:
  %0 = bitcast %struct.cudaArray* %array to i8*, !dbg !820
  tail call void @free(i8* %0) nounwind, !dbg !820
  ret i32 0, !dbg !822
}

define i32 @cudaFreeHost(i8* nocapture %ptr) nounwind uwtable {
entry:
  tail call void @free(i8* %ptr) nounwind, !dbg !823
  ret i32 0, !dbg !825
}
...
entry:
  tail call void @__set_device() nounwind, !dbg !840
  %call = tail call noalias i8* @malloc(i64 %size) nounwind, !dbg !842
  store i8* %call, i8** %devPtr, align 8, !dbg !842, !tbaa !843
  tail call void @__clear_device() nounwind, !dbg !844
  ret i32 0, !dbg !845
}
...
entry:
  tail call void @__set_host() nounwind, !dbg !852
  %call = tail call noalias i8* @malloc(i64 %size) nounwind, !dbg !854
  store i8* %call, i8** %ptr, align 8, !dbg !854, !tbaa !843
  tail call void @__clear_host() nounwind, !dbg !855
  ret i32 0, !dbg !856
}
...
entry:
  %add.ptr = getelementptr inbounds i8* %symbol, i64 %offset, !dbg !903
...
entry:
  %0 = trunc i32 %value to i8, !dbg !910
  %1 = zext i8 %0 to i32
...
!28 = metadata !{i32 786478, i32 0, null, metadata !"dim3", metadata !"dim3", metadata !"_ZN4dim3C1Ejjj", metadata !29, i32 419, metadata !30, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, null, null, metadata !38, metadata !11, i32 419} ; [ 
...
!70 = metadata !{i32 786478, i32 0, null, metadata !"dim3", metadata !"dim3", metadata !"_ZN4dim3C2Ejjj", metadata !29, i32 419, metadata !30, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, null, null, metadata !38, metadata !11, i32 419} ; [ 
!71 = metadata !{metadata !72}
!72 = metadata !{metadata !73}
!73 = metadata !{i32 786484, i32 0, metadata !15, metadata !"my_shared", metadata !"my_shared", metadata !"", metadata !16, i32 9, metadata !74, i32 1, i32 1, [64 x i32]* @_ZZ13device_globalPjS_iE9my_shared} ; [ DW_TAG_variable ] [my_shared] [line 9] [lo
!74 = metadata !{i32 786433, null, metadata !"", null, i32 0, i64 2048, i64 32, i32 0, i32 0, metadata !20, metadata !75, i32 0, i32 0} ; [ DW_TAG_array_type ] [line 0, size 2048, align 32, offset 0] [from unsigned int]
!75 = metadata !{metadata !76}
!76 = metadata !{i32 786465, i64 0, i64 63}       ; [ DW_TAG_subrange_type ] [0, 63]
...
!741 = metadata !{metadata !"brprop"}
!742 = metadata !{i32 14, i32 0, metadata !743, null}
!743 = metadata !{i32 786443, metadata !737, i32 13, i32 0, metadata !16, i32 1} ; [ DW_TAG_lexical_block ] [/home/ibriggs/fairytale/race_01/race_01.cpp]
!744 = metadata !{i32 15, i32 0, metadata !745, null}
!745 = metadata !{i32 786443, metadata !743, i32 14, i32 0, metadata !16, i32 2} ; [ DW_TAG_lexical_block ] [/home/ibriggs/fairytale/race_01/race_01.cpp]
!746 = metadata !{i32 16, i32 0, metadata !745, null}
!747 = metadata !{i32 18, i32 0, metadata !737, null}
!748 = metadata !{i32 22, i32 0, metadata !749, null}
!749 = metadata !{i32 786443, metadata !22, i32 20, i32 0, metadata !16, i32 3} ; [ DW_TAG_lexical_block ] [/home/ibriggs/fairytale/race_01/race_01.cpp]
!750 = metadata !{i32 23, i32 0, metadata !749, null}
!751 = metadata !{i32 24, i32 0, metadata !749, null}
!752 = metadata !{i32 25, i32 0, metadata !749, null}
!753 = metadata !{i32 26, i32 0, metadata !749, null}
!754 = metadata !{i32 29, i32 0, metadata !749, null}
!755 = metadata !{i32 29, i32 0, metadata !756, null}
!756 = metadata !{i32 786443, metadata !749, i32 29, i32 0, metadata !16, i32 4} ; [ DW_TAG_lexical_block ] [/home/ibriggs/fairytale/race_01/race_01.cpp]
!757 = metadata !{i32 30, i32 0, metadata !749, null}
!758 = metadata !{i32 30, i32 0, metadata !759, null}
!759 = metadata !{i32 786443, metadata !749, i32 30, i32 0, metadata !16, i32 5} ; [ DW_TAG_lexical_block ] [/home/ibriggs/fairytale/race_01/race_01.cpp]
!760 = metadata !{i32 31, i32 0, metadata !749, null}
!761 = metadata !{i32 31, i32 0, metadata !762, null}
!762 = metadata !{i32 786443, metadata !749, i32 31, i32 0, metadata !16, i32 6} ; [ DW_TAG_lexical_block ] [/home/ibriggs/fairytale/race_01/race_01.cpp]
!763 = metadata !{i32 34, i32 0, metadata !764, null}
!764 = metadata !{i32 786443, metadata !749, i32 34, i32 0, metadata !16, i32 7} ; [ DW_TAG_lexical_block ] [/home/ibriggs/fairytale/race_01/race_01.cpp]
!765 = metadata !{i32 35, i32 0, metadata !766, null}
!766 = metadata !{i32 786443, metadata !764, i32 34, i32 0, metadata !16, i32 8} ; [ DW_TAG_lexical_block ] [/home/ibriggs/fairytale/race_01/race_01.cpp]
!767 = metadata !{i32 36, i32 0, metadata !768, null}
!768 = metadata !{i32 786443, metadata !766, i32 35, i32 0, metadata !16, i32 9} ; [ DW_TAG_lexical_block ] [/home/ibriggs/fairytale/race_01/race_01.cpp]
!769 = metadata !{i32 37, i32 0, metadata !768, null}
!770 = metadata !{i32 38, i32 0, metadata !771, null}
!771 = metadata !{i32 786443, metadata !766, i32 37, i32 0, metadata !16, i32 10} ; [ DW_TAG_lexical_block ] [/home/ibriggs/fairytale/race_01/race_01.cpp]
!772 = metadata !{i32 41, i32 0, metadata !749, null}
!773 = metadata !{i32 45, i32 0, metadata !774, null}
!774 = metadata !{i32 786443, metadata !749, i32 45, i32 0, metadata !16, i32 11} ; [ DW_TAG_lexical_block ] [/home/ibriggs/fairytale/race_01/race_01.cpp]
!775 = metadata !{i32 46, i32 0, metadata !776, null}
!776 = metadata !{i32 786443, metadata !774, i32 45, i32 0, metadata !16, i32 12} ; [ DW_TAG_lexical_block ] [/home/ibriggs/fairytale/race_01/race_01.cpp]
!777 = metadata !{i32 47, i32 0, metadata !778, null}
!778 = metadata !{i32 786443, metadata !776, i32 46, i32 0, metadata !16, i32 13} ; [ DW_TAG_lexical_block ] [/home/ibriggs/fairytale/race_01/race_01.cpp]
!779 = metadata !{i32 48, i32 0, metadata !778, null}
!780 = metadata !{i32 49, i32 0, metadata !781, null}
!781 = metadata !{i32 786443, metadata !776, i32 48, i32 0, metadata !16, i32 14} ; [ DW_TAG_lexical_block ] [/home/ibriggs/fairytale/race_01/race_01.cpp]
!782 = metadata !{i32 52, i32 0, metadata !749, null}
!783 = metadata !{i32 419, i32 0, metadata !28, metadata !784}
!784 = metadata !{i32 53, i32 0, metadata !785, null}
!785 = metadata !{i32 786443, metadata !749, i32 53, i32 0, metadata !16, i32 15} ; [ DW_TAG_lexical_block ] [/home/ibriggs/fairytale/race_01/race_01.cpp]
!786 = metadata !{i32 419, i32 0, metadata !70, metadata !783}
!787 = metadata !{i32 419, i32 0, metadata !788, metadata !783}
!788 = metadata !{i32 786443, metadata !70, i32 419, i32 0, metadata !29, i32 20} ; [ DW_TAG_lexical_block ] [/home/ibriggs/fairytale/race_01//home/ibriggs/Gklee/Gklee/include/cuda/vector_types.h]
!789 = metadata !{i32 55, i32 0, metadata !785, null}
!790 = metadata !{i32 57, i32 0, metadata !749, null}
!791 = metadata !{i32 60, i32 0, metadata !792, null}
!792 = metadata !{i32 786443, metadata !749, i32 60, i32 0, metadata !16, i32 16} ; [ DW_TAG_lexical_block ] [/home/ibriggs/fairytale/race_01/race_01.cpp]
!793 = metadata !{i32 61, i32 0, metadata !794, null}
!794 = metadata !{i32 786443, metadata !795, i32 61, i32 0, metadata !16, i32 18} ; [ DW_TAG_lexical_block ] [/home/ibriggs/fairytale/race_01/race_01.cpp]
!795 = metadata !{i32 786443, metadata !792, i32 60, i32 0, metadata !16, i32 17} ; [ DW_TAG_lexical_block ] [/home/ibriggs/fairytale/race_01/race_01.cpp]
!796 = metadata !{i32 62, i32 0, metadata !797, null}
!797 = metadata !{i32 786443, metadata !794, i32 61, i32 0, metadata !16, i32 19} ; [ DW_TAG_lexical_block ] [/home/ibriggs/fairytale/race_01/race_01.cpp]
!798 = metadata !{i32 64, i32 0, metadata !795, null}
!799 = metadata !{i32 68, i32 0, metadata !749, null}
!800 = metadata !{i32 69, i32 0, metadata !749, null}
!801 = metadata !{i32 70, i32 0, metadata !749, null}
!802 = metadata !{i32 71, i32 0, metadata !749, null}
!803 = metadata !{i32 13, i32 0, metadata !804, null}
!804 = metadata !{i32 786443, metadata !80, i32 12, i32 0, metadata !81, i32 0} ; [ DW_TAG_lexical_block ] [/home/ibriggs/Gklee/Gklee/runtime/Intrinsic/klee_div_zero_check.c]
!805 = metadata !{i32 14, i32 0, metadata !804, null}
!806 = metadata !{i32 15, i32 0, metadata !804, null}
!807 = metadata !{i32 16, i32 0, metadata !106, null}
!808 = metadata !{i32 17, i32 0, metadata !106, null}
!809 = metadata !{metadata !"omnipotent char", metadata !810}
!810 = metadata !{metadata !"Simple C/C++ TBAA"}
!811 = metadata !{i32 18, i32 0, metadata !106, null}
!812 = metadata !{i32 14, i32 0, metadata !140, null}
!813 = metadata !{i32 15, i32 0, metadata !140, null}
!814 = metadata !{i32 16, i32 0, metadata !140, null}
!815 = metadata !{i32 26, i32 0, metadata !816, null}
!816 = metadata !{i32 786443, metadata !230, i32 25, i32 0, metadata !231, i32 0} ; [ DW_TAG_lexical_block ] [/home/ibriggs/Gklee/Gklee/runtime/CudaRuntime/cudaMemManage.cpp]
!817 = metadata !{i32 30, i32 0, metadata !818, null}
!818 = metadata !{i32 786443, metadata !258, i32 29, i32 0, metadata !231, i32 1} ; [ DW_TAG_lexical_block ] [/home/ibriggs/Gklee/Gklee/runtime/CudaRuntime/cudaMemManage.cpp]
!819 = metadata !{i32 31, i32 0, metadata !818, null}
!820 = metadata !{i32 35, i32 0, metadata !821, null}
!821 = metadata !{i32 786443, metadata !264, i32 34, i32 0, metadata !231, i32 2} ; [ DW_TAG_lexical_block ] [/home/ibriggs/Gklee/Gklee/runtime/CudaRuntime/cudaMemManage.cpp]
!822 = metadata !{i32 36, i32 0, metadata !821, null}
!823 = metadata !{i32 40, i32 0, metadata !824, null}
!824 = metadata !{i32 786443, metadata !270, i32 39, i32 0, metadata !231, i32 3} ; [ DW_TAG_lexical_block ] [/home/ibriggs/Gklee/Gklee/runtime/CudaRuntime/cudaMemManage.cpp]
!825 = metadata !{i32 41, i32 0, metadata !824, null}
!826 = metadata !{i32 45, i32 0, metadata !827, null}
!827 = metadata !{i32 786443, metadata !274, i32 44, i32 0, metadata !231, i32 4} ; [ DW_TAG_lexical_block ] [/home/ibriggs/Gklee/Gklee/runtime/CudaRuntime/cudaMemManage.cpp]
!828 = metadata !{i32 49, i32 0, metadata !829, null}
!829 = metadata !{i32 786443, metadata !282, i32 48, i32 0, metadata !231, i32 5} ; [ DW_TAG_lexical_block ] [/home/ibriggs/Gklee/Gklee/runtime/CudaRuntime/cudaMemManage.cpp]
!830 = metadata !{i32 53, i32 0, metadata !831, null}
!831 = metadata !{i32 786443, metadata !290, i32 52, i32 0, metadata !231, i32 6} ; [ DW_TAG_lexical_block ] [/home/ibriggs/Gklee/Gklee/runtime/CudaRuntime/cudaMemManage.cpp]
!832 = metadata !{i32 57, i32 0, metadata !833, null}
!833 = metadata !{i32 786443, metadata !298, i32 56, i32 0, metadata !231, i32 7} ; [ DW_TAG_lexical_block ] [/home/ibriggs/Gklee/Gklee/runtime/CudaRuntime/cudaMemManage.cpp]
!834 = metadata !{i32 61, i32 0, metadata !835, null}
!835 = metadata !{i32 786443, metadata !306, i32 60, i32 0, metadata !231, i32 8} ; [ DW_TAG_lexical_block ] [/home/ibriggs/Gklee/Gklee/runtime/CudaRuntime/cudaMemManage.cpp]
!836 = metadata !{i32 65, i32 0, metadata !837, null}
!837 = metadata !{i32 786443, metadata !313, i32 64, i32 0, metadata !231, i32 9} ; [ DW_TAG_lexical_block ] [/home/ibriggs/Gklee/Gklee/runtime/CudaRuntime/cudaMemManage.cpp]
!838 = metadata !{i32 69, i32 0, metadata !839, null}
!839 = metadata !{i32 786443, metadata !321, i32 68, i32 0, metadata !231, i32 10} ; [ DW_TAG_lexical_block ] [/home/ibriggs/Gklee/Gklee/runtime/CudaRuntime/cudaMemManage.cpp]
!840 = metadata !{i32 73, i32 0, metadata !841, null}
!841 = metadata !{i32 786443, metadata !325, i32 72, i32 0, metadata !231, i32 11} ; [ DW_TAG_lexical_block ] [/home/ibriggs/Gklee/Gklee/runtime/CudaRuntime/cudaMemManage.cpp]
!842 = metadata !{i32 74, i32 0, metadata !841, null}
!843 = metadata !{metadata !"any pointer", metadata !809}
!844 = metadata !{i32 75, i32 0, metadata !841, null}
!845 = metadata !{i32 77, i32 0, metadata !841, null}
!846 = metadata !{i32 81, i32 0, metadata !847, null}
!847 = metadata !{i32 786443, metadata !332, i32 80, i32 0, metadata !231, i32 12} ; [ DW_TAG_lexical_block ] [/home/ibriggs/Gklee/Gklee/runtime/CudaRuntime/cudaMemManage.cpp]
!848 = metadata !{i32 86, i32 0, metadata !849, null}
!849 = metadata !{i32 786443, metadata !346, i32 85, i32 0, metadata !231, i32 13} ; [ DW_TAG_lexical_block ] [/home/ibriggs/Gklee/Gklee/runtime/CudaRuntime/cudaMemManage.cpp]
!850 = metadata !{i32 91, i32 0, metadata !851, null}
!851 = metadata !{i32 786443, metadata !356, i32 90, i32 0, metadata !231, i32 14} ; [ DW_TAG_lexical_block ] [/home/ibriggs/Gklee/Gklee/runtime/CudaRuntime/cudaMemManage.cpp]
!852 = metadata !{i32 95, i32 0, metadata !853, null}
!853 = metadata !{i32 786443, metadata !366, i32 94, i32 0, metadata !231, i32 15} ; [ DW_TAG_lexical_block ] [/home/ibriggs/Gklee/Gklee/runtime/CudaRuntime/cudaMemManage.cpp]
!854 = metadata !{i32 96, i32 0, metadata !853, null}
!855 = metadata !{i32 97, i32 0, metadata !853, null}
!856 = metadata !{i32 99, i32 0, metadata !853, null}
!857 = metadata !{i32 103, i32 0, metadata !858, null}
!858 = metadata !{i32 786443, metadata !371, i32 102, i32 0, metadata !231, i32 16} ; [ DW_TAG_lexical_block ] [/home/ibriggs/Gklee/Gklee/runtime/CudaRuntime/cudaMemManage.cpp]
!859 = metadata !{i32 108, i32 0, metadata !860, null}
!860 = metadata !{i32 786443, metadata !380, i32 106, i32 0, metadata !231, i32 17} ; [ DW_TAG_lexical_block ] [/home/ibriggs/Gklee/Gklee/runtime/CudaRuntime/cudaMemManage.cpp]
!861 = metadata !{i32 113, i32 0, metadata !862, null}
!862 = metadata !{i32 786443, metadata !389, i32 112, i32 0, metadata !231, i32 18} ; [ DW_TAG_lexical_block ] [/home/ibriggs/Gklee/Gklee/runtime/CudaRuntime/cudaMemManage.cpp]
!863 = metadata !{i32 119, i32 0, metadata !864, null}
!864 = metadata !{i32 786443, metadata !401, i32 118, i32 0, metadata !231, i32 19} ; [ DW_TAG_lexical_block ] [/home/ibriggs/Gklee/Gklee/runtime/CudaRuntime/cudaMemManage.cpp]
!865 = metadata !{i32 125, i32 0, metadata !866, null}
!866 = metadata !{i32 786443, metadata !415, i32 124, i32 0, metadata !231, i32 20} ; [ DW_TAG_lexical_block ] [/home/ibriggs/Gklee/Gklee/runtime/CudaRuntime/cudaMemManage.cpp]
!867 = metadata !{i32 131, i32 0, metadata !868, null}
!868 = metadata !{i32 786443, metadata !431, i32 130, i32 0, metadata !231, i32 21} ; [ DW_TAG_lexical_block ] [/home/ibriggs/Gklee/Gklee/runtime/CudaRuntime/cudaMemManage.cpp]
!869 = metadata !{i32 137, i32 0, metadata !870, null}
!870 = metadata !{i32 786443, metadata !444, i32 136, i32 0, metadata !231, i32 22} ; [ DW_TAG_lexical_block ] [/home/ibriggs/Gklee/Gklee/runtime/CudaRuntime/cudaMemManage.cpp]
!871 = metadata !{i32 143, i32 0, metadata !872, null}
!872 = metadata !{i32 786443, metadata !458, i32 142, i32 0, metadata !231, i32 23} ; [ DW_TAG_lexical_block ] [/home/ibriggs/Gklee/Gklee/runtime/CudaRuntime/cudaMemManage.cpp]
!873 = metadata !{i32 149, i32 0, metadata !874, null}
!874 = metadata !{i32 786443, metadata !471, i32 148, i32 0, metadata !231, i32 24} ; [ DW_TAG_lexical_block ] [/home/ibriggs/Gklee/Gklee/runtime/CudaRuntime/cudaMemManage.cpp]
!875 = metadata !{i32 153, i32 0, metadata !876, null}
!876 = metadata !{i32 786443, metadata !485, i32 152, i32 0, metadata !231, i32 25} ; [ DW_TAG_lexical_block ] [/home/ibriggs/Gklee/Gklee/runtime/CudaRuntime/cudaMemManage.cpp]
!877 = metadata !{i32 157, i32 0, metadata !878, null}
!878 = metadata !{i32 786443, metadata !509, i32 156, i32 0, metadata !231, i32 26} ; [ DW_TAG_lexical_block ] [/home/ibriggs/Gklee/Gklee/runtime/CudaRuntime/cudaMemManage.cpp]
!879 = metadata !{i32 161, i32 0, metadata !880, null}
!880 = metadata !{i32 786443, metadata !516, i32 160, i32 0, metadata !231, i32 27} ; [ DW_TAG_lexical_block ] [/home/ibriggs/Gklee/Gklee/runtime/CudaRuntime/cudaMemManage.cpp]
!881 = metadata !{i32 165, i32 0, metadata !882, null}
!882 = metadata !{i32 786443, metadata !535, i32 164, i32 0, metadata !231, i32 28} ; [ DW_TAG_lexical_block ] [/home/ibriggs/Gklee/Gklee/runtime/CudaRuntime/cudaMemManage.cpp]
!883 = metadata !{i32 171, i32 0, metadata !884, null}
!884 = metadata !{i32 786443, metadata !542, i32 170, i32 0, metadata !231, i32 29} ; [ DW_TAG_lexical_block ] [/home/ibriggs/Gklee/Gklee/runtime/CudaRuntime/cudaMemManage.cpp]
!885 = metadata !{i32 176, i32 0, metadata !886, null}
!886 = metadata !{i32 786443, metadata !555, i32 175, i32 0, metadata !231, i32 30} ; [ DW_TAG_lexical_block ] [/home/ibriggs/Gklee/Gklee/runtime/CudaRuntime/cudaMemManage.cpp]
!887 = metadata !{i32 181, i32 0, metadata !888, null}
!888 = metadata !{i32 786443, metadata !565, i32 180, i32 0, metadata !231, i32 31} ; [ DW_TAG_lexical_block ] [/home/ibriggs/Gklee/Gklee/runtime/CudaRuntime/cudaMemManage.cpp]
!889 = metadata !{i32 187, i32 0, metadata !890, null}
!890 = metadata !{i32 786443, metadata !576, i32 186, i32 0, metadata !231, i32 32} ; [ DW_TAG_lexical_block ] [/home/ibriggs/Gklee/Gklee/runtime/CudaRuntime/cudaMemManage.cpp]
!891 = metadata !{i32 192, i32 0, metadata !892, null}
!892 = metadata !{i32 786443, metadata !588, i32 191, i32 0, metadata !231, i32 33} ; [ DW_TAG_lexical_block ] [/home/ibriggs/Gklee/Gklee/runtime/CudaRuntime/cudaMemManage.cpp]
!893 = metadata !{i32 198, i32 0, metadata !894, null}
!894 = metadata !{i32 786443, metadata !598, i32 197, i32 0, metadata !231, i32 34} ; [ DW_TAG_lexical_block ] [/home/ibriggs/Gklee/Gklee/runtime/CudaRuntime/cudaMemManage.cpp]
!895 = metadata !{i32 203, i32 0, metadata !896, null}
!896 = metadata !{i32 786443, metadata !609, i32 201, i32 0, metadata !231, i32 35} ; [ DW_TAG_lexical_block ] [/home/ibriggs/Gklee/Gklee/runtime/CudaRuntime/cudaMemManage.cpp]
!897 = metadata !{i32 209, i32 0, metadata !898, null}
!898 = metadata !{i32 786443, metadata !619, i32 207, i32 0, metadata !231, i32 36} ; [ DW_TAG_lexical_block ] [/home/ibriggs/Gklee/Gklee/runtime/CudaRuntime/cudaMemManage.cpp]
!899 = metadata !{i32 214, i32 0, metadata !900, null}
!900 = metadata !{i32 786443, metadata !630, i32 213, i32 0, metadata !231, i32 37} ; [ DW_TAG_lexical_block ] [/home/ibriggs/Gklee/Gklee/runtime/CudaRuntime/cudaMemManage.cpp]
!901 = metadata !{i32 220, i32 0, metadata !902, null}
!902 = metadata !{i32 786443, metadata !641, i32 219, i32 0, metadata !231, i32 38} ; [ DW_TAG_lexical_block ] [/home/ibriggs/Gklee/Gklee/runtime/CudaRuntime/cudaMemManage.cpp]
!903 = metadata !{i32 225, i32 0, metadata !904, null}
!904 = metadata !{i32 786443, metadata !653, i32 224, i32 0, metadata !231, i32 39} ; [ DW_TAG_lexical_block ] [/home/ibriggs/Gklee/Gklee/runtime/CudaRuntime/cudaMemManage.cpp]
!905 = metadata !{i32 226, i32 0, metadata !904, null}
!906 = metadata !{i32 231, i32 0, metadata !907, null}
!907 = metadata !{i32 786443, metadata !663, i32 230, i32 0, metadata !231, i32 40} ; [ DW_TAG_lexical_block ] [/home/ibriggs/Gklee/Gklee/runtime/CudaRuntime/cudaMemManage.cpp]
!908 = metadata !{i32 235, i32 0, metadata !909, null}
!909 = metadata !{i32 786443, metadata !674, i32 234, i32 0, metadata !231, i32 41} ; [ DW_TAG_lexical_block ] [/home/ibriggs/Gklee/Gklee/runtime/CudaRuntime/cudaMemManage.cpp]
!910 = metadata !{i32 239, i32 0, metadata !911, null}
!911 = metadata !{i32 786443, metadata !681, i32 238, i32 0, metadata !231, i32 42} ; [ DW_TAG_lexical_block ] [/home/ibriggs/Gklee/Gklee/runtime/CudaRuntime/cudaMemManage.cpp]
!912 = metadata !{i32 240, i32 0, metadata !911, null}
!913 = metadata !{i32 245, i32 0, metadata !914, null}
!914 = metadata !{i32 786443, metadata !689, i32 244, i32 0, metadata !231, i32 43} ; [ DW_TAG_lexical_block ] [/home/ibriggs/Gklee/Gklee/runtime/CudaRuntime/cudaMemManage.cpp]
!915 = metadata !{i32 250, i32 0, metadata !916, null}
!916 = metadata !{i32 786443, metadata !699, i32 249, i32 0, metadata !231, i32 44} ; [ DW_TAG_lexical_block ] [/home/ibriggs/Gklee/Gklee/runtime/CudaRuntime/cudaMemManage.cpp]
!917 = metadata !{i32 255, i32 0, metadata !918, null}
!918 = metadata !{i32 786443, metadata !710, i32 254, i32 0, metadata !231, i32 45} ; [ DW_TAG_lexical_block ] [/home/ibriggs/Gklee/Gklee/runtime/CudaRuntime/cudaMemManage.cpp]
!919 = metadata !{i32 260, i32 0, metadata !920, null}
!920 = metadata !{i32 786443, metadata !718, i32 259, i32 0, metadata !231, i32 46} ; [ DW_TAG_lexical_block ] [/home/ibriggs/Gklee/Gklee/runtime/CudaRuntime/cudaMemManage.cpp]
!921 = metadata !{i32 264, i32 0, metadata !922, null}
!922 = metadata !{i32 786443, metadata !727, i32 263, i32 0, metadata !231, i32 47} ; [ DW_TAG_lexical_block ] [/home/ibriggs/Gklee/Gklee/runtime/CudaRuntime/cudaMemManage.cpp]
