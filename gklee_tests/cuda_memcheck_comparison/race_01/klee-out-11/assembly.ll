...
if.then:                                          ; preds = %entry
  ...
  %arrayidx8 = getelementptr inbounds [1024 x i32]* @_ZZ13device_globalPjS_iE9my_shared, i32 0, i64 %idxprom7, !dbg !742
...
entry:
  ...
  %call = call noalias i8* @malloc(i64 4096) nounwind, !dbg !748
  ...
  %call1 = call i32 @cudaMalloc(i8** %1, i64 4096), !dbg !751
  store i32* null, i32** %device_array_b, align 8, !dbg !752
  %2 = bitcast i32** %device_array_b to i8**, !dbg !753
  %call2 = call i32 @cudaMalloc(i8** %2, i64 4096), !dbg !753
...
for.cond:                                         ; preds = %for.inc, %if.end8
  ...
  %cmp9 = icmp slt i32 %6, 1024, !dbg !763
...
for.end:                                          ; preds = %for.cond
  ...
  %call15 = call i32 @cudaMemcpy(i8* %14, i8* %16, i64 1024, i32 1), !dbg !772
...
for.cond17:                                       ; preds = %for.inc31, %for.end
  ...
  %cmp18 = icmp slt i32 %17, 1024, !dbg !773
...
for.end33:                                        ; preds = %for.cond17
  ...
  %call34 = call i32 @cudaMemcpy(i8* %27, i8* %29, i64 1024, i32 1), !dbg !782
  ...
  store i32 1024, i32* %vx.addr.i6, align 4
  ...
  call void @_Z13device_globalPjS_i(i32* %88, i32* %89, i32 1024), !dbg !789
  ...
  %call36 = call i32 @cudaMemcpy(i8* %91, i8* %93, i64 1024, i32 2), !dbg !790
...
for.cond38:                                       ; preds = %for.end49, %for.end33
  ...
  %cmp39 = icmp slt i32 %94, 1024, !dbg !791
...
for.cond41:                                       ; preds = %for.body43, %for.body40
  ...
  %cmp42 = icmp slt i32 %95, 1024, !dbg !793
...
for.end49:                                        ; preds = %for.cond41
  ...
  %add52 = add nsw i32 %101, 1024, !dbg !791
