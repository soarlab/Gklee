...
@_ZZ13device_globalPjS_iE9my_shared = internal global [32 x i32] zeroinitializer, section "__shared__", align 16
...
entry:
  ...
  %arrayidx = getelementptr inbounds [32 x i32]* @_ZZ13device_globalPjS_iE9my_shared, i32 0, i64 %idxprom, !dbg !738
...
if.then:                                          ; preds = %entry
  ...
  %arrayidx8 = getelementptr inbounds [32 x i32]* @_ZZ13device_globalPjS_iE9my_shared, i32 0, i64 %idxprom7, !dbg !741
...
entry:
  ...
  %call = call noalias i8* @malloc(i64 128) nounwind, !dbg !747
  ...
  %call1 = call i32 @cudaMalloc(i8** %1, i64 128), !dbg !750
  store i32* null, i32** %device_array_b, align 8, !dbg !751
  %2 = bitcast i32** %device_array_b to i8**, !dbg !752
  %call2 = call i32 @cudaMalloc(i8** %2, i64 128), !dbg !752
...
for.cond:                                         ; preds = %for.inc, %if.end8
  ...
  %cmp9 = icmp slt i32 %6, 32, !dbg !762
...
for.end:                                          ; preds = %for.cond
  ...
  %call15 = call i32 @cudaMemcpy(i8* %14, i8* %16, i64 32, i32 1), !dbg !771
...
for.cond17:                                       ; preds = %for.inc31, %for.end
  ...
  %cmp18 = icmp slt i32 %17, 32, !dbg !772
...
for.end33:                                        ; preds = %for.cond17
  ...
  %call34 = call i32 @cudaMemcpy(i8* %27, i8* %29, i64 32, i32 1), !dbg !781
  call void @_ZN4dim3C1Ejjj(%struct.dim3* %agg.tmp, i32 1, i32 1, i32 1), !dbg !782
  call void @_ZN4dim3C1Ejjj(%struct.dim3* %agg.tmp35, i32 32, i32 1, i32 1), !dbg !782
  ...
  call void @_Z13device_globalPjS_i(i32* %44, i32* %45, i32 32), !dbg !784
  ...
  %call36 = call i32 @cudaMemcpy(i8* %47, i8* %49, i64 32, i32 2), !dbg !785
...
for.cond38:                                       ; preds = %for.end49, %for.end33
  ...
  %cmp39 = icmp slt i32 %50, 32, !dbg !786
...
for.cond41:                                       ; preds = %for.body43, %for.body40
  ...
  %cmp42 = icmp slt i32 %51, 32, !dbg !788
...
for.end49:                                        ; preds = %for.cond41
  ...
  %add52 = add nsw i32 %57, 32, !dbg !786
...
!73 = metadata !{i32 786484, i32 0, metadata !15, metadata !"my_shared", metadata !"my_shared", metadata !"", metadata !16, i32 9, metadata !74, i32 1, i32 1, [32 x i32]* @_ZZ13device_globalPjS_iE9my_shared} ; [ DW_TAG_variable ] [my_shared] [line 9] [lo
!74 = metadata !{i32 786433, null, metadata !"", null, i32 0, i64 1024, i64 32, i32 0, i32 0, metadata !20, metadata !75, i32 0, i32 0} ; [ DW_TAG_array_type ] [line 0, size 1024, align 32, offset 0] [from unsigned int]
!75 = metadata !{metadata !76}
!76 = metadata !{i32 786465, i64 0, i64 31}       ; [ DW_TAG_subrange_type ] [0, 31]
